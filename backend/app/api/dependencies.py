...
require_exam_sessions = require_permission(Permission.exam_sessions)
require_exam_monitor = require_permission(Permission.exam_monitor)
require_exam_violations_read = require_permission(Permission.exam_violations_read)
require_exam_violations_review = require_permission(Permission.exam_violations_review)
require_exam_reports_export = require_permission(Permission.exam_reports_export)
