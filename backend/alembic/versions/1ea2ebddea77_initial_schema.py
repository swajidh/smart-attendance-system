...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("admin", "teacher", "counselor", "student", name="userrole"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("embedding_status", sa.Enum("not_enrolled", "enrolled", "failed", name="embeddingstatus"), nullable=False, server_default="not_enrolled"),
    ...
    op.create_table(
        ...
        sa.Column("course_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("status", sa.Enum("active", "closed", "cancelled", name="sessionstatus"), nullable=False, server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("student_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("status", sa.Enum("present", "absent", "unknown", name="attendancestatus"), nullable=False, server_default="absent"),
        sa.Column("confidence", sa.Float(), nullable=True),
        sa.Column("first_seen", sa.DateTime(timezone=True), nullable=True),
        sa.Column("marked_by", sa.Enum("auto", "manual", name="markedby"), nullable=False, server_default="auto"),
    ...
    op.create_table(
        ...
        sa.Column("alert_type", sa.Enum("low_attendance", "low_engagement", "unknown_face", "system", name="alerttype"), nullable=False),
