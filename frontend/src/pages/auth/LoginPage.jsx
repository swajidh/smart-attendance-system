...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('smart_attendance_token', data.access_token);
      localStorage.setItem('smart_attendance_user', JSON.stringify(data.user));
      toast.success(`Welcome back, ${data.user.name}!`);
      // Students go to their portal; all other roles go to the dashboard
      const destination = data.user.role === 'student' ? '/portal' : '/dashboard';
